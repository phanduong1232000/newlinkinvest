          ...
          <div className="relative">
            ...
            <div className="">
              <div className="flex items-end justify-center -mb-2 md:-mb-4 h-full">
                <Link href={`/ban-lanh-dao?name=${director.link}`} className="bg-gradient-to-r from-[#0C6985] to-[#09303D] hover:text-black cursor-pointer hover:from-[#f8e2b7ad] hover:to-[#D9B770]  px-8 md:px-12 py-2 rounded-2xl  flex flex-col items-center justify-center border border-[#E7CE8D]">
