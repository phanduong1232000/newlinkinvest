...
const NicOverview = () => {
  return (
    <div className="relative z-50 py-5 md:py-10 px-2 mt-20  lg:px-0 ">
      <h1 className="text-[42px] lg:text-[80px] font-utm-avo-bold  bg-gradient-to-t from-[#FAD48A] from-[0%] via-[#FFF5BE] via-[50%] to-[#D9B770] to-[100%] bg-clip-text text-transparent">
        NEWLINK
      </h1>
      <br />
      <h2 className="block font-utm-avo-bold text-[24px] lg:text-[48px] mt-[-5px] lg:mt-[-20px]">
        INVESTMENT
      </h2>
      <div className="md:w-[430px] lg:w-[540px] space-y-4 relative z-50">
        ...
        <h3 className="text-[12px] lg:text-[16px] font-utm-avo ">
