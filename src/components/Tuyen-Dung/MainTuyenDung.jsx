...
const MainTuyenDung = () => {
  return (
    <div className="max-w-[650px] space-y-4 font-utm-avo">
      <h1 className="text-[24px] md:text-[48px] font-utm-avo  bg-gradient-to-t from-[#FAD48A] from-[0%] via-[#FFF5BE] via-[50%] to-[#D9B770] to-[100%] bg-clip-text text-transparent">NEWLINK TUYỂN DỤNG</h1>
      <div>
        <p className="font-utm-avo-bold text-[16px] md:text-[20px]">Tìm kiếm công việc mơ ước của bạn</p>
